...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Provision the Jason Autotask read-only OpenBao "
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "jason-autotask-read-policy.hcl"
        ),
    )
    parser.add_argument(
        "--credential-dir",
...
def main() -> int:
    ...
    if arguments.credential_dir.exists():
        raise ProvisioningError(
            "The Autotask read credential directory already exists. "
    ...
    try:
        ...
        raise ProvisioningError(
            "The Autotask read policy file is unavailable."
        ) from error
    ...
    policy_name = "jason-autotask-read"
    role_name = "jason-autotask-read"
    ...
    try:
        ...
        metadata = {
            ...
            "policy": policy_name,
            "role_name": role_name,
            "connector_identity": "autotask-read",
            "environment": "production",
        ...
        print("Autotask read-only policy installed.")
        print("Autotask read-only AppRole configured.")

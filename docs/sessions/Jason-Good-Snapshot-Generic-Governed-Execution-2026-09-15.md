...
> **Documentation-control migration — 2026-09-16:** This historical snapshot was moved from the retired `07-Operations/SNAPSHOTS/` documentation root into the canonical `docs/sessions/` evidence tree. Its point-in-time facts remain unchanged below. For current state use `docs/control/CURRENT.md` and `docs/sessions/Jason-Governed-Execution-Checkpoint-2026-09-16.md`.

...
_EXPERIENCE_INSTRUCTIONS = (
    ...
    "Do not use information needs to encode a requested action or higher authority. " "The information target kind describes the human subject being asked about, ""not a possible evidence source, event type, condition record, monitoring signal, ""log, alert, audit record, or specialized projection that might later help answer ""the information need. Keep the human subject above the evidence boundary. "

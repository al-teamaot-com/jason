...
_PROVIDER_CAPABILITY_MAP = {
    ...
    (IT_GLUE_PROVIDER, DOCUMENTATION_ATTACHMENT_SEARCH): "it_glue.document.attachment.search",
    (IT_GLUE_PROVIDER, DOCUMENTATION_ATTACHMENT_READ): "it_glue.document.attachment.get",
    (IT_GLUE_PROVIDER, DOCUMENTATION_ATTACHMENT_CONTENT_READ): "it_glue.document.attachment.content.get",
    (IT_GLUE_PROVIDER, DOCUMENTATION_FLEXIBLE_ASSET_SEARCH): "it_glue.entity.query",
    (IT_GLUE_PROVIDER, DOCUMENTATION_FLEXIBLE_ASSET_READ): "it_glue.entity.get",
    (IT_GLUE_PROVIDER, DOCUMENTATION_FLEXIBLE_ASSET_TYPE_SEARCH): "it_glue.entity.query",
    (IT_GLUE_PROVIDER, DOCUMENTATION_FLEXIBLE_ASSET_TYPE_READ): "it_glue.entity.get",
    ...
    (AUTOTASK_PROVIDER, SERVICE_RESOURCE_SEARCH): "autotask.entity.query",
    (AUTOTASK_PROVIDER, SERVICE_RESOURCE_READ): "autotask.entity.get",
    ...
    (AUTOTASK_PROVIDER, SERVICE_TICKET_ATTACHMENT_SEARCH): "autotask.ticket.attachments.list",
    (AUTOTASK_PROVIDER, SERVICE_TICKET_ATTACHMENT_READ): "autotask.ticket.attachment.get",
    (AUTOTASK_PROVIDER, SERVICE_TICKET_ATTACHMENT_CONTENT_READ): "autotask.ticket.attachment.content.get",
    ...
    (AUTOTASK_PROVIDER, SERVICE_CONTRACT_SEARCH): "autotask.entity.query",
    (AUTOTASK_PROVIDER, SERVICE_CONTRACT_READ): "autotask.entity.query",
    (AUTOTASK_PROVIDER, SERVICE_ENTITY_DESCRIBE): "autotask.entity.describe",
    (AUTOTASK_PROVIDER, SERVICE_ENTITY_FIELDS_DESCRIBE): "autotask.entity.fields.describe",
    (AUTOTASK_PROVIDER, SERVICE_NOTIFICATION_HISTORY_SEARCH): "autotask.notification_history.search",
    (AUTOTASK_PROVIDER, SERVICE_PRODUCT_SEARCH): "autotask.entity.query",
    (AUTOTASK_PROVIDER, SERVICE_PRODUCT_READ): "autotask.entity.get",
    (AUTOTASK_PROVIDER, SERVICE_PRODUCT_VENDOR_SEARCH): "autotask.entity.query",
    (AUTOTASK_PROVIDER, SERVICE_SERVICE_SEARCH): "autotask.entity.query",
    (AUTOTASK_PROVIDER, SERVICE_SERVICE_READ): "autotask.entity.get",
    (AUTOTASK_PROVIDER, SERVICE_SERVICE_BUNDLE_SEARCH): "autotask.entity.query",
    (AUTOTASK_PROVIDER, SERVICE_SERVICE_BUNDLE_READ): "autotask.entity.get",
    (AUTOTASK_PROVIDER, SERVICE_PURCHASE_ORDER_SEARCH): "autotask.entity.query",
    (AUTOTASK_PROVIDER, SERVICE_PURCHASE_ORDER_READ): "autotask.entity.get",
    (AUTOTASK_PROVIDER, SERVICE_PURCHASE_ORDER_ITEM_SEARCH): "autotask.entity.query",
    (AUTOTASK_PROVIDER, SERVICE_TICKET_CHARGE_SEARCH): "autotask.entity.query",
